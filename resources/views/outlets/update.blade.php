                    ...
                    <form action="{{ route('outlet.update', $outlet->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="w-full px-4 lg:w-2/3 mx-auto">
                            <div class="w-full px-4 mb-8 pt-4 flex relative">
                                <input type="text" placeholder="Nama"  name="nama" id="nama"  class="w-full bg-slate-200 peer placeholder:font-semibold placeholder:text-red-400  text-dark p-3 rounded-md border-none focus:ring-0 focus:placeholder:opacity-0 transition-all duration-500" value="{{ old('nama') ?? $outlet->nama }}">
                            ...
                            <div class="w-full px-4 mb-8 pt-4 flex relative">
                                <input type="text" placeholder="Alamat"  name="alamat" id="alamat"  class="w-full bg-slate-200 peer placeholder:font-semibold placeholder:text-red-400  text-dark p-3 rounded-md border-none focus:ring-0 focus:placeholder:opacity-0 transition-all duration-500" value="{{ old('alamat') ?? $outlet->alamat }}">
                            ...
                            <div class="w-full px-4 mb-8 pt-4 flex relative">
                                <input type="text" placeholder="telepon"  name="telepon" id="telepon"  class="w-full bg-slate-200 peer placeholder:font-semibold placeholder:text-red-400  text-dark p-3 rounded-md border-none focus:ring-0 focus:placeholder:opacity-0 transition-all duration-500" value="{{ old('telepon') ?? $outlet->telepon }}">
